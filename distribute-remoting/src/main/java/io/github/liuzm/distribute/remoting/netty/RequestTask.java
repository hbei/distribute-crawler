...
public class RequestTask implements Runnable {
    ...
    public RequestTask(final Runnable runnable, final Channel channel, final Command request) {
    ...
    public void returnResponse(int code, String remark) {
        final Command response = Command.createResponseCommand(code, remark);
