...
public class AQClientInitializer {
	...
	public static void buildClient(NettyRemotingClient nettyClient,Context context){
		...
		nettyClient.registerProcessor(HeaderMessageCode.SYSTEM_ERROR, new SystemProcessor(context), Executors.newCachedThreadPool());
	}
}
